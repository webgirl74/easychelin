...
<body>
  ...
  <div class="adminBox">
    ...
    <div class="bbs_wrap">
      <!-- 현재위치 -->
      <location>홈 > 상품관리 > 상품상세보기</location>
      <!-- 타이틀 -->
      <div class="pageTitle">::: 상품상세보기 </div>
    ...
    <form action="" method="post" name="frm" id="frm">
      ...
      <table class="orderView">
        ...
        <tr>
          <td>상품등록일</td>
          <td>2021-01-01 14:23:15</td>
          <td>상품수정일</td>
          <td>2021-01-03 14:23:15</td>
        </tr>
        <tr>
          <td>카테고리1</td>
          <td>
            <select name="goodsCate1">              
              <option value="">1차 카테괴 선택</option>
      ...
      <table class="orderView">
        ...
        <tr>
          <td>여분필드1</td>
          <td>
            <textarea id="buy_message" name="goods_noname1" rows="2" cols="150"></textarea>
          </td>
        </tr>
        <tr>
          <td>여분필드2</td>
          <td>
            <textarea id="buy_message" name="goods_noname2" rows="2" cols="150"></textarea>
          </td>
        </tr>
      </table>
      <!-- | 여분필드 테이블 end -->
