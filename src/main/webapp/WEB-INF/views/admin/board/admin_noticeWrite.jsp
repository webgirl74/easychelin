      ...
      <form action="" method="post" name="frm" id="frm">
        <table class="writeTable">
          ...
          <tr>
            <td>선택</td>
            <td>
              <input class="check" type="radio" id="notice_opt1" name="notice_opt" checked><label for="notice_opt1">일반공지&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
              <input class="check" type="radio" id="notice_opt2" name="notice_opt"><label for="notice_opt2">중요공지</label>            
            </td>
          </tr>
          <tr>
            <td>제목</td>
            <td>
              <input type="text" name="notice_title" placeholer="제목을 입력해 주세요." size="100">
            </td>
          </tr>
          <tr>
            <td>내용</td>
          ...
          <tr>
            <td colspan="2" class="btnTd">
              <input type="submit" value="저장" class="btnSch">
