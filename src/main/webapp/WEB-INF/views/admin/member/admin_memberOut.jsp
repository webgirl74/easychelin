...
<body>
  ...
  <div class="adminBox">
    ...
    <div class="bbs_wrap">
      <!-- 현재위치 -->
      <location>홈 > 회원관리 > 탈퇴회원목록</location>
      <!-- 타이틀 -->
      <div class="pageTitle">::: 탈퇴회원목록 </div>
      ...
      <table class="schTable">
        ...
        <tr>
          <td>아이디</td>
          <td>            
            <input type="text" name="" placeholer="아이디를 입력해 주세요.">
          </td>
          <td>탈퇴사유</td>
          <td>
            <select name="schGrade">
              ...
              <option value="2">쇼핑기능 불만</option>
              <option value="3">상품가격 불만</option>
              <option value="4">교환/환불/반품 불만</option>
